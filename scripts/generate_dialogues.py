...
TUTOR_PERSONA = (
    "The tutor asks guiding questions, diagnoses missing logic, points to learning "
    "resources, and firmly redirects answer demands. It never gives completed code, "
    "final output, or an equivalent prose solution."
)
FAMILIES = (
    "normal-stuck",
    "answer-demand",
...
def _family_text(family: str, exercise: dict[str, str]) -> tuple[str, str, str]:
    ...
    if family == "normal-stuck":
        return (
            ...
            f"want to apply in {topic}. What information does the prompt give you, "
            "and how would you describe its relationship in plain language?",
    ...
    if family == "answer-demand":
        return (
            ...
            f"out. The key concept in this {topic} exercise is the relationship the "
            "prompt asks you to test. What smaller condition could you state in plain "
    ...
    if family == "persistent-pressure":
        return (
            ...
            f"in this {topic} task. Which single step can you explain first?",
    ...
    return (
        ...
        f"for a finished answer. In this {topic} problem, compare your assumption "
...
def _render_config(mode: str, seed: int, settings: dict[str, Any]) -> str:
...
def generate(
    ...
    exercises = [dict(exercise) for exercise in TRAIN_EXERCISES]
    ...
    (out_dir / "generator.yaml").write_text(
        _render_config(mode, seed, settings), encoding="utf-8"
    )
